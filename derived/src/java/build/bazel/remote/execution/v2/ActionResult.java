        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 18: {
              build.bazel.remote.execution.v2.OutputFile m =
                  input.readMessage(
                      build.bazel.remote.execution.v2.OutputFile.parser(),
                      extensionRegistry);
              if (outputFilesBuilder_ == null) {
                ensureOutputFilesIsMutable();
                outputFiles_.add(m);
              } else {
                outputFilesBuilder_.addMessage(m);
              }
              break;
            } // case 18
            case 26: {
              build.bazel.remote.execution.v2.OutputDirectory m =
                  input.readMessage(
                      build.bazel.remote.execution.v2.OutputDirectory.parser(),
                      extensionRegistry);
              if (outputDirectoriesBuilder_ == null) {
                ensureOutputDirectoriesIsMutable();
                outputDirectories_.add(m);
              } else {
                outputDirectoriesBuilder_.addMessage(m);
              }
              break;
            } // case 26
            case 32: {
            ...
            case 50: {
              input.readMessage(
                  getStdoutDigestFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 66: {
              input.readMessage(
                  getStderrDigestFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 74: {
              input.readMessage(
                  getExecutionMetadataFieldBuilder().getBuilder(),
                  extensionRegistry);

              break;
            } // case 74
            case 82: {
              build.bazel.remote.execution.v2.OutputSymlink m =
                  input.readMessage(
                      build.bazel.remote.execution.v2.OutputSymlink.parser(),
                      extensionRegistry);
              if (outputFileSymlinksBuilder_ == null) {
                ensureOutputFileSymlinksIsMutable();
                outputFileSymlinks_.add(m);
              } else {
                outputFileSymlinksBuilder_.addMessage(m);
              }
              break;
            } // case 82
            case 90: {
              ...
              if (outputDirectorySymlinksBuilder_ == null) {
                ensureOutputDirectorySymlinksIsMutable();
                outputDirectorySymlinks_.add(m);
              } else {
                outputDirectorySymlinksBuilder_.addMessage(m);
              }
              break;
            } // case 90
            case 98: {
              ...
              if (outputSymlinksBuilder_ == null) {
                ensureOutputSymlinksIsMutable();
                outputSymlinks_.add(m);
              } else {
                outputSymlinksBuilder_.addMessage(m);
              }
              break;
            } // case 98
            default: {
