...
private static final long serialVersionUID = 0L;
  ...
  public static final int PARTIAL_EXECUTION_METADATA_FIELD_NUMBER = 5;
  private build.bazel.remote.execution.v2.ExecutedActionMetadata partialExecutionMetadata_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public boolean hasPartialExecutionMetadata() {
    return partialExecutionMetadata_ != null;
  }
  /**
   * <pre>
   * The client can read this field to view details about the ongoing
   ...
   */
  @java.lang.Override
  public build.bazel.remote.execution.v2.ExecutedActionMetadata getPartialExecutionMetadata() {
    return partialExecutionMetadata_ == null ? build.bazel.remote.execution.v2.ExecutedActionMetadata.getDefaultInstance() : partialExecutionMetadata_;
  }
  /**
   * <pre>
   * The client can read this field to view details about the ongoing
   ...
   */
  @java.lang.Override
  public build.bazel.remote.execution.v2.ExecutedActionMetadataOrBuilder getPartialExecutionMetadataOrBuilder() {
    return getPartialExecutionMetadata();
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (partialExecutionMetadata_ != null) {
      output.writeMessage(5, getPartialExecutionMetadata());
    }
  ...
  public int getSerializedSize() {
    ...
    if (partialExecutionMetadata_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(5, getPartialExecutionMetadata());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasPartialExecutionMetadata() != other.hasPartialExecutionMetadata()) return false;
    if (hasPartialExecutionMetadata()) {
      if (!getPartialExecutionMetadata()
          .equals(other.getPartialExecutionMetadata())) return false;
    }
  ...
  public int hashCode() {
    ...
    if (hasPartialExecutionMetadata()) {
      hash = (37 * hash) + PARTIAL_EXECUTION_METADATA_FIELD_NUMBER;
      hash = (53 * hash) + getPartialExecutionMetadata().hashCode();
    }
  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      if (partialExecutionMetadataBuilder_ == null) {
        partialExecutionMetadata_ = null;
      } else {
        partialExecutionMetadata_ = null;
        partialExecutionMetadataBuilder_ = null;
      }
      return this;
    }
    ...
    public build.bazel.remote.execution.v2.ExecuteOperationMetadata buildPartial() {
      ...
      if (partialExecutionMetadataBuilder_ == null) {
        result.partialExecutionMetadata_ = partialExecutionMetadata_;
      } else {
        result.partialExecutionMetadata_ = partialExecutionMetadataBuilder_.build();
      }
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(build.bazel.remote.execution.v2.ExecuteOperationMetadata other) {
      ...
      if (other.hasPartialExecutionMetadata()) {
        mergePartialExecutionMetadata(other.getPartialExecutionMetadata());
      }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              input.readMessage(
                  getPartialExecutionMetadataFieldBuilder().getBuilder(),
                  extensionRegistry);
  ...
  checkByteStringIsUtf8(value);
    ...
    private build.bazel.remote.execution.v2.ExecutedActionMetadata partialExecutionMetadata_;
    private com.google.protobuf.SingleFieldBuilderV3<
        build.bazel.remote.execution.v2.ExecutedActionMetadata, build.bazel.remote.execution.v2.ExecutedActionMetadata.Builder, build.bazel.remote.execution.v2.ExecutedActionMetadataOrBuilder> partialExecutionMetadataBuilder_;
    /**
     * <pre>
     * The client can read this field to view details about the ongoing
     * execution.
     ...
     */
    public boolean hasPartialExecutionMetadata() {
      return partialExecutionMetadataBuilder_ != null || partialExecutionMetadata_ != null;
    }
    /**
     * <pre>
     * The client can read this field to view details about the ongoing
    ...
    public build.bazel.remote.execution.v2.ExecutedActionMetadata getPartialExecutionMetadata() {
      if (partialExecutionMetadataBuilder_ == null) {
        ...
        return partialExecutionMetadataBuilder_.getMessage();
      }
    }
    /**
     * <pre>
     ...
     * <code>.build.bazel.remote.execution.v2.ExecutedActionMetadata partial_execution_metadata = 5;</code>
     */
    public Builder setPartialExecutionMetadata(build.bazel.remote.execution.v2.ExecutedActionMetadata value) {
      if (partialExecutionMetadataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        partialExecutionMetadata_ = value;
        onChanged();
      } else {
        partialExecutionMetadataBuilder_.setMessage(value);
      }
     ...
     * <code>.build.bazel.remote.execution.v2.ExecutedActionMetadata partial_execution_metadata = 5;</code>
     */
    public Builder setPartialExecutionMetadata(
        build.bazel.remote.execution.v2.ExecutedActionMetadata.Builder builderForValue) {
      if (partialExecutionMetadataBuilder_ == null) {
        partialExecutionMetadata_ = builderForValue.build();
        onChanged();
      } else {
        partialExecutionMetadataBuilder_.setMessage(builderForValue.build());
      }
     ...
     * <code>.build.bazel.remote.execution.v2.ExecutedActionMetadata partial_execution_metadata = 5;</code>
     */
    public Builder mergePartialExecutionMetadata(build.bazel.remote.execution.v2.ExecutedActionMetadata value) {
      if (partialExecutionMetadataBuilder_ == null) {
        if (partialExecutionMetadata_ != null) {
          partialExecutionMetadata_ =
            build.bazel.remote.execution.v2.ExecutedActionMetadata.newBuilder(partialExecutionMetadata_).mergeFrom(value).buildPartial();
        } else {
          partialExecutionMetadata_ = value;
        }
        onChanged();
      } else {
        partialExecutionMetadataBuilder_.mergeFrom(value);
      }
     ...
     * <code>.build.bazel.remote.execution.v2.ExecutedActionMetadata partial_execution_metadata = 5;</code>
     */
    public Builder clearPartialExecutionMetadata() {
      if (partialExecutionMetadataBuilder_ == null) {
        partialExecutionMetadata_ = null;
        onChanged();
      } else {
     ...
     * <code>.build.bazel.remote.execution.v2.ExecutedActionMetadata partial_execution_metadata = 5;</code>
     */
    public build.bazel.remote.execution.v2.ExecutedActionMetadata.Builder getPartialExecutionMetadataBuilder() {
      
      onChanged();
      return getPartialExecutionMetadataFieldBuilder().getBuilder();
    }
    /**
     * <pre>
     * The client can read this field to view details about the ongoing
    ...
    public build.bazel.remote.execution.v2.ExecutedActionMetadataOrBuilder getPartialExecutionMetadataOrBuilder() {
      if (partialExecutionMetadataBuilder_ != null) {
        return partialExecutionMetadataBuilder_.getMessageOrBuilder();
      } else {
        return partialExecutionMetadata_ == null ?
            build.bazel.remote.execution.v2.ExecutedActionMetadata.getDefaultInstance() : partialExecutionMetadata_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getPartialExecutionMetadataFieldBuilder() {
      if (partialExecutionMetadataBuilder_ == null) {
        partialExecutionMetadataBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            build.bazel.remote.execution.v2.ExecutedActionMetadata, build.bazel.remote.execution.v2.ExecutedActionMetadata.Builder, build.bazel.remote.execution.v2.ExecutedActionMetadataOrBuilder>(
      ...
      return partialExecutionMetadataBuilder_;
    }
    @java.lang.Override
