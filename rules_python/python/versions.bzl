...
TOOL_VERSIONS = {
    ...
    "3.14.4.1": {
    "url": "python_pkg/python-3.14.4.1-s390x-ibm-zos.tar.gz",
    "sha256": {
        "s390x-zos": "050a5790965d5a9f1b1e822d317b10dd67a8e790db68355b524364e101908274",
    },
    "strip_prefix": "python",
},
}
...
PLATFORMS = {
     "s390x-ibm-zos": struct(
        compatible_with = [
        # keep linux for now if needed
        "@platforms//os:zos",
        "@platforms//cpu:s390x",
        ],
       os_name = ZOS_NAME,
