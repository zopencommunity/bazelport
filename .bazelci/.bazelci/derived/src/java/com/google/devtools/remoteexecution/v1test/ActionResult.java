        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 18: {
              com.google.devtools.remoteexecution.v1test.OutputFile m =
                  input.readMessage(
                      com.google.devtools.remoteexecution.v1test.OutputFile.parser(),
                      extensionRegistry);
              if (outputFilesBuilder_ == null) {
                ensureOutputFilesIsMutable();
                outputFiles_.add(m);
            ...
            case 26: {
              com.google.devtools.remoteexecution.v1test.OutputDirectory m =
                  input.readMessage(
                      com.google.devtools.remoteexecution.v1test.OutputDirectory.parser(),
                      extensionRegistry);
              if (outputDirectoriesBuilder_ == null) {
                ensureOutputDirectoriesIsMutable();
